...
public class StoryEngine {
    ...
    private <T> TaskResponse<T> doFire(StoryRequest<T> storyRequest, ScopeDataQuery scopeDataQuery) throws InterruptedException, TimeoutException {
        ...
        try {
            ...
            Object result = storyBus.getResult().orElse(null);
            if (storyRequest.getResultBuilder() != null) {
                result = storyRequest.getResultBuilder().apply(result, storyBus.getScopeDataOperator());
            }
