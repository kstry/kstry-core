...
public class BasicKvAbility implements KvAbility {
    ...
    public <T> Optional<T> getObject(String key, Class<T> clazz) {
        ...
        return valueOptional.map(o -> JSON.parseObject(JSON.toJSONString(o, GlobalConstant.SERIALIZE_SF), clazz));
    }
    ...
    public Optional<String> getString(String key) {
        ...
        return valueOptional.map(v -> {
            ...
            return JSON.toJSONString(v, SerializerFeature.DisableCircularReferenceDetect);
        });
    }
    ...
    public <T> List<T> getList(String key, Class<T> clazz) {
        ...
        return JSON.parseArray(JSON.toJSONString(valueOptional.get(), GlobalConstant.SERIALIZE_SF), clazz);
    }
