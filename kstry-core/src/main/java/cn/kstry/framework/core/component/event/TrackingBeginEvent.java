...
public class TrackingBeginEvent extends ApplicationEvent {
    ...
    public TrackingBeginEvent(String startId, String businessId, String requestId, NodeTracking nodeTracking) {
        super(nodeTracking);
