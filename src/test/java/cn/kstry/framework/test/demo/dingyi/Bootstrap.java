 ...
 */
@Configuration
@ComponentScan(basePackageClasses = cn.kstry.framework.test.demo.dingyi.Bootstrap.class)
...
public class Bootstrap {
    ...
    public interface ARole extends TaskActionOperatorRole {

    }

    public static void main(String[] args) {
        AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(cn.kstry.framework.test.demo.dingyi.Bootstrap.class);
        context.getBean("storyEngine", StoryEngine.class);
    }
}
