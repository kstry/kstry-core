...
public enum ExceptionEnum {
     ...
     * [K1010001] 未捕获异常
     */
    SYSTEM_ERROR(ComponentTypeEnum.GLOBAL, "0001", "System error!"),
     ...
     */
    MUST_ONE_TASK_ACTION(ComponentTypeEnum.GLOBAL, "0007", "Only one task is allowed to be executed!"),
     ...
     *  [K1020001] Task 被重复定义
     */
    TASK_IDENTIFY_DUPLICATE_DEFINITION(ComponentTypeEnum.TASK, "0001", "event group duplication of definitions is not allowed!"),

    /**
     *  [K1020002] Task 中不允许出现方法重载
     */
    NOT_ALLOWED_OVERLOADS(ComponentTypeEnum.TASK, "0002", "Method overloads are not allowed in Task!"),

    /**
     * [K1020003] Task 获取 bean 属性信息失败
     */
    FAILED_GET_PROPERTY(ComponentTypeEnum.TASK, "0003", "BeanUtils failed to get bean property!"),

    /**
     * [K1020004] Task 设置 bean 属性信息失败
     */
    FAILED_SET_PROPERTY(ComponentTypeEnum.TASK, "0004", "BeanUtils failed to set bean property!"),
